...
/** @var array $rows */
?>
<div class="card"><h2 style="margin:0 0 6px 0;">UDA快件 / 问题订单 / 问题原因管理</h2></div>
<?php if (!$schemaReady): ?><div class="card" style="border-left:4px solid #dc2626;">问题原因相关表不存在。</div><?php return; endif; ?>
