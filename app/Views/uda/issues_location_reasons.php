...
?>
<div class="card">
    <h2 style="margin:0 0 6px 0;"><?php echo htmlspecialchars(t('uda.page.issues_location_reasons.title', 'UDA快件 / 问题订单 / 地点原因维护')); ?></h2>
    <div class="muted"><?php echo htmlspecialchars(t('uda.page.issues_location_reasons.subtitle', '已将 V1 的「问题原因管理 + 地点管理」合并到同页。')); ?></div>
</div>

<?php if (!$schemaReady): ?>
    <div class="card" style="border-left:4px solid #dc2626;"><?php echo htmlspecialchars(t('uda.page.issues_location_reasons.schema', '相关表不存在，请先执行 `031_uda_express_problem_orders_tables.sql`。')); ?></div>
    <?php return; ?>
<?php endif; ?>
...
<div class="card">
    <h3 style="margin-top:0;"><?php echo htmlspecialchars(t('uda.page.issues_location_reasons.reason_list', '问题原因列表')); ?></h3>
    <div style="overflow:auto;">
        <table class="data-table">
